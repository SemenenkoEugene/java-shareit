...
public class ItemController {
    ...
    @GetMapping("/{itemId}")
    public ItemDto getItemById(@RequestHeader(HEADER) final Long userId,
                               @PathVariable final Long itemId) {
    ...
    @GetMapping
    public List<ItemDto> getItemsByOwnerId(@RequestHeader(HEADER) final Long userId,
    ...
    @GetMapping("/search")
    public List<ItemDto> getItemsBySearchQuery(@RequestParam(name = "text") final String searchText,
                                               @RequestParam(required = false, defaultValue = "0") final int from,
                                               @RequestParam(required = false, defaultValue = "20") final int size) {
